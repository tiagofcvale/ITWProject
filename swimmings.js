var vm = function () {
    ...
    self.getParticipantDetails = function (participantId, participant) {
        var detailsUri = `http://192.168.160.58/Paris2024/api/Swimmings/${encodeURIComponent(participantId)}`;
    ...
    self.loadParticipants = function (EventId, StageId) {
        var composedUri = `http://192.168.160.58/Paris2024/api/Swimmings/Participants?EventId=${encodeURIComponent(EventId)}&StageId=${encodeURIComponent(StageId)}`;
        ...
        ajaxHelper(composedUri, 'GET').done(function (data) {
            ...
            if (Array.isArray(data)) {
                const participantPromises = data.map(function (item) {
                    ...
                    const participantDetailsUri = `http://192.168.160.58/Paris2024/api/Swimmings/${participantId}`;
    ...
    self.loadParticipantDetails = function (participantId) {
        var composedUri = `http://192.168.160.58/Paris2024/api/Swimmings/${encodeURIComponent(participantId)}`;
